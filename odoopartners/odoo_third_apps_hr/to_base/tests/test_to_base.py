...
class TestToBase(TransactionCase):
    ...
    def test_validate_period_name(self):
        validate_period_name = self.env['to.base']._validate_period_name

        self.assertEqual(validate_period_name('hourly')[0], 'hourly')
        self.assertEqual(validate_period_name('hour')[0], 'hourly')

        self.assertEqual(validate_period_name('daily')[0], 'daily')
        self.assertEqual(validate_period_name('day')[0], 'daily')

        self.assertEqual(validate_period_name('weekly')[0], 'weekly')
        self.assertEqual(validate_period_name('week')[0], 'weekly')

        self.assertEqual(validate_period_name('monthly')[0], 'monthly')
        self.assertEqual(validate_period_name('month')[0], 'monthly')

        self.assertEqual(validate_period_name('quarterly')[0], 'quarterly')
        self.assertEqual(validate_period_name('quarter')[0], 'quarterly')

        self.assertEqual(validate_period_name('biannually')[0], 'biannually')
        self.assertEqual(validate_period_name('biannual')[0], 'biannually')

        self.assertEqual(validate_period_name('annually')[0], 'annually')
        self.assertEqual(validate_period_name('annual')[0], 'annually')
        self.assertEqual(validate_period_name('year')[0], 'annually')
    ...
    def test_091_period_iter__datetime(self):
        ...
        test_vals = [
            {
                'period_name': 'hourly',
                'dt_start': datetime.datetime(2021, 2, 1, 6, 30),
                'dt_end': datetime.datetime(2021, 2, 1, 11),
                'cycle_value': 1,
            },
            {
                'period_name': 'hourly',
            ...
            },
            {
                'period_name': 'hourly',
                'dt_start': datetime.datetime(2021, 2, 1, 6, 30),
                'dt_end': datetime.datetime(2021, 2, 2, 11),
                'cycle_value': 6,
            },
        ]
        expected_vals = [
            # hourly
            [
                datetime.datetime(2021, 2, 1, 6, 30),
                datetime.datetime(2021, 2, 1, 6, 59, 59, 999999),
                datetime.datetime(2021, 2, 1, 7, 59, 59, 999999),
                datetime.datetime(2021, 2, 1, 8, 59, 59, 999999),
                datetime.datetime(2021, 2, 1, 9, 59, 59, 999999),
                datetime.datetime(2021, 2, 1, 10, 59, 59, 999999),
                datetime.datetime(2021, 2, 1, 11),
                ],
            [
                datetime.datetime(2021, 2, 1, 6, 30),
                datetime.datetime(2021, 2, 1, 7, 59, 59, 999999),
            ...
            [
                datetime.datetime(2021, 2, 1, 6, 30),
                datetime.datetime(2021, 2, 1, 11, 59, 59, 999999),
                datetime.datetime(2021, 2, 1, 17, 59, 59, 999999),
                datetime.datetime(2021, 2, 1, 23, 59, 59, 999999),
                datetime.datetime(2021, 2, 2, 5, 59, 59, 999999),
                datetime.datetime(2021, 2, 2, 11),
                ],
            ]
        for i in range(len(test_vals)):
            self.assertEqual(
        ...
        test_vals = [
            ...
            },
            {
                'period_name': 'daily',
                'dt_start': datetime.datetime(2021, 2, 1, 6, 30),
                'dt_end': datetime.datetime(2021, 2, 5, 11),
                'cycle_value': 1,
            },
            {
                'period_name': 'daily',
                'dt_start': datetime.datetime(2021, 2, 1, 6, 30),
                'dt_end': datetime.datetime(2021, 2, 10, 11),
                'cycle_value': 3,
            },
        ]
        expected_vals = [
            ...
            [
                ...
                datetime.datetime(2021, 2, 3, 23, 59, 59, 999999),
                datetime.datetime(2021, 2, 4, 23, 59, 59, 999999),
                datetime.datetime(2021, 2, 5, 11),
                ],
            [
                datetime.datetime(2021, 2, 1, 6, 30),
                datetime.datetime(2021, 2, 3, 23, 59, 59, 999999),
                datetime.datetime(2021, 2, 6, 23, 59, 59, 999999),
                datetime.datetime(2021, 2, 9, 23, 59, 59, 999999),
                datetime.datetime(2021, 2, 10, 11),
                ],
            ]
        for i in range(len(test_vals)):
            self.assertEqual(
        ...
        test_vals = [
            ...
            },
            {
                'period_name': 'annually',
                'dt_start': datetime.datetime(2021, 1, 15),
                'dt_end': datetime.datetime(2024, 11, 29),
                'cycle_value': 2,
            }
        ]
        expected_vals = [
    ...
    def test_092_period_iter__date(self):
        # hourly
        with self.assertRaises(ValidationError):
            self.env['to.base'].period_iter(**{
                'period_name': 'hourly',
                'dt_start': datetime.date(2021, 2, 1),
                'dt_end': datetime.date(2021, 2, 1),
                'cycle_value': 1,
            }),
        ...
        test_vals = [
            {
                'period_name': 'daily',
                'dt_start': datetime.date(2021, 2, 1),
                'dt_end': datetime.date(2021, 2, 2),
                'cycle_value': 1,
            },
            {
                'period_name': 'daily',
                'dt_start': datetime.date(2021, 2, 1),
                'dt_end': datetime.date(2021, 2, 5),
                'cycle_value': 1,
            },
            {
                'period_name': 'daily',
                'dt_start': datetime.date(2021, 2, 1),
                'dt_end': datetime.date(2021, 2, 7),
                'cycle_value': 3,
            },
        ]
        expected_vals = [
        ...
        test_vals = [
            ...
            },
            {
                'period_name': 'annually',
                'dt_start': datetime.date(2021, 1, 15),
                'dt_end': datetime.date(2024, 11, 29),
                'cycle_value': 2,
            }
        ]
        check_vals = [
    ...
    def test_get_ratio_between_periods(self):
        test_vals = [
            ('hourly', 1, 'hourly', 1),
            ('annually', 1, 'monthly', 1),
            ('monthly', 2, 'annually', 1),
            ('annually', 1, 'monthly', 1, datetime.datetime(2021, 2, 1)),
            ('annually', 1, 'weekly', 1, datetime.datetime(2022, 2, 9)),
            ('monthly', 1, 'daily', 2, datetime.datetime(2024, 2, 9)),
            ('monthly', 1, 'weekly', 1, datetime.datetime(2024, 2, 9)),
            ('monthly', 1, 'hourly', 1, datetime.datetime(2024, 2, 9)),
            ('hourly', 4, 'monthly', 1, datetime.datetime(2024, 2, 9)),
            ('annually', 1, 'weekly', 4, datetime.datetime(2024, 2, 9)),
        ]
        check_vals = [1, 12, 2 / 12, 12, 365 / 7, 29 / 2, 29 / 7, 29 * 24, 4 / (29 * 24), 366 / (7 * 4)]
        for i in range(len(test_vals)):
            self.assertEqual(
