...
2. Ấn bản Enterprise
    ...
    'website': 'https://viindoo.com/apps/app/17.0/to_base',
    ...
    'assets': {
        'web.assets_backend': [
            'to_base/static/src/webclient/**/*',
            'to_base/static/src/js/settings_page.js',
            'to_base/static/src/xml/settings_page.xml',
            'to_base/static/src/search_panel/search_panel.xml',
            'to_base/static/src/search_panel/search_panel.js',
            'to_base/static/src/search_panel/search_panel.scss',
            ],
        'web.tests_assets': [
