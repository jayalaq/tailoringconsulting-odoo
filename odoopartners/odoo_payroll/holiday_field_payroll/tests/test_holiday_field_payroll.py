...
class TestHrPayslip(common.TransactionCase):
    ...
    def test_payslip(self):
        ...
        _logger.info("------TYPE EMPLOYE CREATED SUCCESSFULLY---- COMPLETE------")
        ...
        _logger.info("------CONTRACT CREATED SUCCESSFULLY---- COMPLETE------")
        ...
        _logger.info("------PAYSLIP CREATED SUCCESSFULLY---- COMPLETE------")
        ...
        _logger.info("--------LEAVE ALLOCATION CREATED SUCCESFULLY---------")
        ...
        _logger.info("--------LEAVE CREATED SUCCESFULLY---------")        
