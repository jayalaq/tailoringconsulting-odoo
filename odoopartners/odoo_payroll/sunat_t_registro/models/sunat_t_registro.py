        ...
        if not self.employees_lines_ids_t:
            ...
            for employee in employees:
                if self.date_from and self.date_to and employee.service_hire_date and self.date_from <= employee.service_hire_date <= self.date_to:
                    ...
                    essalud_indicator = '1' if employee.work_contact_id.indicator_essalud == '01' else '2'
                    ...
                    ide_data.append({
                        ...
                        'road_type_code': str(employee.work_contact_id.road_type.code).rjust(2, '0'),
                        'road_type_name': employee.work_contact_id.road_name,
                        'road_number': employee.work_contact_id.road_number,
                        'road_departament': employee.work_contact_id.road_departament,
                        'road_inside': employee.work_contact_id.road_inside,
                        'road_mz': employee.work_contact_id.road_mz,
                        'road_batch': employee.work_contact_id.road_batch,
                        'road_km': employee.work_contact_id.road_km,
                        'road_block': employee.work_contact_id.road_block,
                        'road_stage': employee.work_contact_id.road_stage,
                        'zone_type': employee.work_contact_id.zone_type.code,
                        'zone_name': employee.work_contact_id.zone_name,
                        'zone_reference': employee.work_contact_id.zone_reference,
                        'zone_ubigeo': employee.work_contact_id.zone_ubigeo.code,
                        'road_type_2': str(employee.work_contact_id.road_type_2.code).rjust(2, '0'),
                        'road_name_2': employee.work_contact_id.road_name_2,
                        'road_number_2': employee.work_contact_id.road_number_2,
                        'road_departament_2': employee.work_contact_id.road_departament_2,
                        'road_inside_2': employee.work_contact_id.road_inside_2,
                        'road_mz_2': employee.work_contact_id.road_mz_2,
                        'road_batch_2': employee.work_contact_id.road_batch_2,
                        'road_km_2': employee.work_contact_id.road_km_2,
                        'road_block_2': employee.work_contact_id.road_block_2,
                        'road_stage_2': employee.work_contact_id.road_stage_2,
                        'zone_type_2': employee.work_contact_id.zone_type_2.code,
                        'zone_name_2': employee.work_contact_id.zone_name_2,
                        'zone_reference_2': employee.work_contact_id.zone_reference_2,
                        'zone_ubigeo_2': employee.work_contact_id.zone_ubigeo_2.code,
    ...
    def _get_data_cta(self):
        ...
        for employee in self.employees_lines_ids_t:
            data_emp = self.env['res.partner.bank'].search(
                [('partner_id', '=', employee.work_contact_id.id), '|', ('company_id', '=', False),
                 ('company_id', '=', employee.company_id.id)])
            for x in data_emp:
                if employee.work_contact_id.id == x.partner_id.id:
                    if x.acc_type == 'wage':
