...
class HrLeaveAllocation(models.Model):
    ...
    #: model:ir.model.fields.selection,name:holidays_accrual_advanced.selection__hr_leave_allocation__unit_per_interval__hours
    ...
    def create(self, values):
        for value in values:
            if 'holiday_type' in value and value['holiday_type'] != 'employee':
                value['allocation_type'] = 'regular'

            accrual = value.get('allocation_type') and value['allocation_type'] == 'accrual'
            date_from = value.get('date_from', None)
