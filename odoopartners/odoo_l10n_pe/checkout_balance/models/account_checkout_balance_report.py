    ...
    def _dynamic_lines_generator(self, report, options, all_column_groups_expression_totals, warnings=None):
        ...
        def _insert_balance_values(balance_key, debit_index, credit_index):
            ...
            if difference > 0:
                ...
                result_exercise_period_columns.insert(debit_index, {
                    'name': report._format_value(options, 0.0, figure_type='monetary', blank_if_zero=False),
                    'no_format': 0.0,
                    'class': 'number'
                })
                result_exercise_period_columns.insert(credit_index, {
                    'name': report._format_value(options, difference, figure_type='monetary', blank_if_zero=False),
            ...
            result_totals_columns.insert(debit_index, {
                'name': report._format_value(options, totals_debit, figure_type='monetary', blank_if_zero=False),
                'no_format': totals_debit,
                'class': 'number'
            })
            result_totals_columns.insert(credit_index, {
                'name': report._format_value(options, totals_credit, figure_type='monetary', blank_if_zero=False),
        ...
        if lines:
            ...
            result_exercise_period_line = {
                'id': report._get_generic_line_id(None, None, markup='result_exercise_period'),
            ...
            # Totals
            result_totals_line = {
                'id': report._get_generic_line_id(None, None, markup='final_totals'),
                'name': _('Totals'),
                'class': 'total',
                'level': 1,
                'unfoldable': False,
