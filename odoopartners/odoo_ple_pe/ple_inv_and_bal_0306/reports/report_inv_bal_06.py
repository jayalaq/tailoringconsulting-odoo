...
class ReportInvBalSixExcel(object):
    ...
    def get_content(self):
        ...
        headers = [
            'Periodo', 'CUO', 'Numero Correlativo', 'Tipo de documento deudor',
            'Número de documento deudor', 'Apellidos y Nombres, Den. o Raz. Social deudor',
            'Tipo de Comprobante de Pago de la cuenta por cobrar provisional',
            'Número serie del comprobante de pago o documento o número de serie',
            'Número de Comprobante de Pago de la cuenta por cobrar provisional',
            'Fecha de emisión del Comprobante de Pago o Fecha de inicio de la operación',
            'Monto de cada provisión del deudor', 'Indica el estado de la operación',
