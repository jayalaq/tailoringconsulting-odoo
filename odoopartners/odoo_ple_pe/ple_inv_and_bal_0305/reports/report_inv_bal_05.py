...
class ReportInvBalFourExcel(object):
    ...
    def get_filename(self):
        ...
        return 'Libro_Cuentas por Cobrar Diversas_{}.xlsx'.format(year_month)
...
class ReportInvBalFourTxt(object):
    ...
    def get_filename(self):
        ...
        return 'LE{vat}{period_year}{period_month}{period_day}030500{eeff_oportunity}{state_send}{has_info}11.txt'.format(
