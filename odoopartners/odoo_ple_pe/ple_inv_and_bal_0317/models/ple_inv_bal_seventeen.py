...
class PleInvBalSeventeen(models.Model):
    ...
    def action_generate_data_seventeen(self):
       ...
       """
        ...
        condition_active_passive = sum_total_active_balance_account - sum_total_passive_balance_account
        exercise_passive_account = abs(condition_active_passive) if condition_active_passive >= 0 else 0.00
        exercise_active_account = abs(condition_active_passive) if condition_active_passive < 0 else 0.00

        condition_losses_earnings = sum_total_result_earnings - sum_total_result_losses
        exercise_result_losses = abs(condition_losses_earnings) if condition_losses_earnings >= 0 else 0.00
        exercise_result_earnings = abs(condition_losses_earnings) if condition_losses_earnings < 0 else 0.00
