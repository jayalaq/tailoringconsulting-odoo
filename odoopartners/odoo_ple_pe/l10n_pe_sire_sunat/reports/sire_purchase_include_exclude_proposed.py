...
class SirePurchaseIncludeExcludeProposedXlsx:
    def __init__(self, obj, processed_results):
        self.obj = obj
        self.processed_results = processed_results

    def __str__(self):
        return "Reporte RCE - Incluir/Excluir datos de la propuesta XLSX - {}, {}{}".format(
    ...
    def _write_rows_report(workbook, worksheet, processed_results):
        ...
        for dict_result in processed_results:
            ...
            worksheet.write(row, 1, '', style_content)
            worksheet.write(row, 2, '', style_content)
            worksheet.write(row, 3, '', style_content)
            worksheet.write(row, 4, car_sunat, style_content)
            ...
            worksheet.write(row, 10, dict_result['ref_correlative'].lstrip('0'), style_content)
...
class SirePurchaseIncludeExcludeProposedTxt:
    def __init__(self, obj, processed_results):
        self.obj = obj
        self.processed_results = processed_results

    def __str__(self):
        return "Reporte RCE - Incluir/Excluir datos de la propuesta TXT - {}, {}{}".format(
            self.obj.company_id.name,
            self.obj.year,
            self.obj.month
        )
    ...
    def _write_template_report(template, processed_results):
        ...
        for dict_result in processed_results:
            ...
            content += template.format(
                ...
                ref_correlative=dict_result['ref_correlative'].lstrip('0'),
