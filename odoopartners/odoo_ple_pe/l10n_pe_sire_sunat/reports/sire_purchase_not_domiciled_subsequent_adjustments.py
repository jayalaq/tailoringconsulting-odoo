...
class SirePurchaseNotDomiciledSubsequentAdjustmentsXlsx:
    def __init__(self, obj, processed_results):
        self.obj = obj
        self.processed_results = processed_results

    def __str__(self):
        return "Reporte RCE no domiciliados - Cuando realiza ajustes posteriores XLSX - {}, {}{}".format(
    ...
    def _write_rows_report(workbook, worksheet, processed_results):
        ...
        for dict_result in processed_results:
            ...
            car_orig = "{}{}{}{}".format(
                str(dict_result['partner_vat']).zfill(11),
                dict_result['document_type_code'],
                str(dict_result['ref_serie']).zfill(4),
            ...
            worksheet.write(row, 6, ref_correlative.lstrip('0'), style_content)
            ...
            worksheet.write(row, 35, car_orig, style_content)
            row += 1
...
class SirePurchaseNotDomiciledSubsequentAdjustmentsTxt:
    def __init__(self, obj, processed_results):
        self.obj = obj
        self.processed_results = processed_results

    def __str__(self):
        return "Reporte RCE no domiciliados - Cuando realiza ajustes posteriores TXT - {}, {}{}".format(
            self.obj.company_id.name,
            self.obj.year,
            self.obj.month
        )
    ...
    def _get_template_report():
        return '{period}||{invoice_date}|' \
            ...
            '{taken_code}|{application_article}|{car_orig}|\r\n'
