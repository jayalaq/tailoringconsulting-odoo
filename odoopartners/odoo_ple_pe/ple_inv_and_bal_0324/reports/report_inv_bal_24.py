...
class ReportInvBal24Excel(object):
    ...
    def get_content(self):
        ...
        ws = workbook.add_worksheet('F3.24 Est Gan y Perd Fun')
    ...
    def get_filename(self):
        ...
        return 'Libro_Estado de Resultados_Integrales{}.xlsx'.format(year_month)


class ReportInvBal24Txt(object):
    ...
    def get_filename(self):
        ...
        return 'LE{vat}{period_year}{period_month}{period_day}032400{eeff_oportunity}{state_send}{has_info}11.txt'.format(
