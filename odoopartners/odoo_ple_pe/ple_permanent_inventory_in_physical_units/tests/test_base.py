...
class TestAccountAccount(TransactionCase):
    ...
    def test_fields_view_get(self):
        ...
        view = self.AccountAccount._get_view(view_type='form')
...
class TestProductTemplate(TransactionCase):
    ...
    def test_fields_view_get(self):
        "Check fields_view_get method"
        view = self.ProductTemplate._get_view(view_type='form')
        self.assertTrue(view)
...
class TestStockLocation(TransactionCase):
    ...
    def test_fields_view_get(self):
        "Check fields_view_get method"
        view = self.StockLocation._get_view(view_type='form')
        self.assertTrue(view)
...
class TestStockPicking(TransactionCase):
    ...
    def test_fields_view_get(self):
        "Check fields_view_get method"
        view = self.StockPicking._get_view(view_type='form')
        self.assertTrue(view)
...
class TestStockPickingType(TransactionCase):
    ...
    def test_fields_view_get(self):
        "Check fields_view_get method"
        view = self.StockPickingType._get_view(view_type='form')
        self.assertTrue(view)
