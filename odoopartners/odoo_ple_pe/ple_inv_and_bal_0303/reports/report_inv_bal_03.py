...
class ReportInvBalThreeExcel(object):
    ...
    def get_content(self):
        ...
        ws = workbook.add_worksheet('Reporte CXC')
    ...
    def get_filename(self):
        ...
        return 'Libro_Cuentas por cobrar_{}.xlsx'.format(year_month)
        {
            1: {"codigoorigen": '90100108', "codigodestino": "90100101", "codigoactivo": "TPH-337", "estadoactivo": '2'},
            2: {"codigoorigen": '90100108', "codigodestino": '90100101', "codigoactivo": 'FPH-2960', "estadoactivo": '2'},
            3: {"codigoorigen": '90100108', "codigodestino": '90100101', "codigoactivo": 'DPH-2688', "estadoactivo": '2'}
        }


class ReportInvBalThreeTxt(object):
    ...
    def get_filename(self):
        ...
        return 'LE{vat}{period_year}{period_month}{period_day}030300{eeff_oportunity}{state_send}{has_info}11.txt'.format(
