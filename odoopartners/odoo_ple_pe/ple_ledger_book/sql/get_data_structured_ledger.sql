CREATE OR REPLACE FUNCTION get_data_structured_ledger(journal_type VARCHAR,journal_no_incluide_ple BOOLEAN, move_is_nodomicilied BOOLEAN, move_name VARCHAR, move_date DATE)
RETURNS VARCHAR
language plpgsql
as
$$
