    ...
    def _compute_to_force_exchange_rate(self):
        for wizard in self:
            ...
            if wizard.payment_method_line_id.name == 'Detracción':
                ...
                wizard.to_force_exchange_rate = line_move_id.to_force_exchange_rate if line_move_id.to_force_exchange_rate and line_move_id.to_force_exchange_rate > 0.0 else line_move_id.exchange_rate
                self.to_force_exchange_rate = wizard.to_force_exchange_rate
