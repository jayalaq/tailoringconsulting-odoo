...
class AccountMove(models.Model):
    ...
    def _get_l10n_latam_documents_domain(self):
        ...
        internal_types_domain = [('internal_type', 'in', internal_types), ('country_id', '=', self.company_id.account_fiscal_country_id.id)]
        
        if self.company_id.country_id.code != "PE" or not self.journal_id.l10n_latam_use_documents or self.journal_id.type != "sale":
            return internal_types_domain
        
        internal_types_domain.append(("code", "in", ("01", "03", "07", "08", "20", "40")))
        return internal_types_domain
    ...
    def get_all_prefix_from_documents(self):
    ...
    def fix_prefix_name(self):
        all_prefix = self.get_all_prefix_from_documents()
    ...
    def _inverse_l10n_latam_document_number(self):
        all_prefix = self.get_all_prefix_from_documents()
        recs = self.filtered(lambda x: x.l10n_latam_document_type_id)
        for rec in recs:
