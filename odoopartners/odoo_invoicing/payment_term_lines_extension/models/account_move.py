...
class AccountMove(models.Model):
    ...
    def _onchange_account_id(self):
        ...
        filtered_lines = [line for line in self.line_ids if line.display_type == "payment_term"]
    ...
    def _get_payment_terms_account(self):
        ...
        if self.partner_id:
            ...
            account_id = partner.with_company(self.company_id).property_account_receivable_id if condition else partner.with_company(
                self.company_id).property_account_payable_id
            if account_id and account_id.company_id == self.company_id:
                return account_id
        # Search new account.
        domain = [
