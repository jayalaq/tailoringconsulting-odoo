...
class HrLeave(models.Model):
    ...
    def create_attendance_period(self, request_date_from, request_date_to, employee_ids, leave):
        attendance_list = []
    ...
    def action_approve(self):
        ...
        for rec in self:
            if not rec.hr_attendance_ids and rec.report_attendance:
                hr_attendance_ids = rec.create_attendance_period(rec.date_from, rec.date_to, rec.employee_ids, rec)
